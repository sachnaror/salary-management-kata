...
## Mandatory Workflow
1. Read `rulechain/DOMAIN_RULES.md`.
2. Read `rulechain/DECISION_LOG.md`.
3. Read `rulechain/TEST_MATRIX.md`.
4. Read the active file in `rulechain/CHANGE_REQUESTS/`.
...
6. If any ambiguity, conflict, or missing acceptance criteria exists:
   - write the questions into `rulechain/OPEN_QUESTIONS.md`
...
8. After implementation, update:
   ...
   - the active `rulechain/CHANGE_REQUESTS/...md`
